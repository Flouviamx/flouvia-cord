...
completo y verificado end-to-end; el módulo de presupuestos fue eliminado por completo (ago 2026) para 
simplificar el producto. Las áreas activas de desarrollo reciente son cobros por términos de 
crédito/anticipo/recurrentes, y pasadas de pulido visual "Apple/iOS/Stripe" en la app y la landing. 
El detalle cronológico completo de CADA feature vive en los archivos de arriba.
