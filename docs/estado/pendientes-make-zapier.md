# Lo que falta para las apps de Cord en otras plataformas
...
| **n8n** | `n8n-nodes-cord` 1.1.0 en npm con constancia de origen, sobre la plantilla oficial de n8n; pasa el revisor de n8n | Tarjeta con "Crear llave de API" | Enviado a verificación de n8n el 2026-09-21; esperar su respuesta para que aparezca en n8n Cloud |
