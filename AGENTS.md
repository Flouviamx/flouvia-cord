...
AGENTS.md se dividió (jul 2026) para mejor organización. **No se perdió nada** —
...
|---------|--------------|---------------|
| **`AGENTS.md`** (este) | Comandos, las 9 Reglas de Diseño core, Stack, Variables de entorno, Deployment, este índice. | Siempre — lo esencial que aplica a TODO. |
...
> billing→negocio-billing, landing→landing, UI→sistema-de-diseno) para que AGENTS.md no
...
AI_MODEL=                                                       # opcional (default Codex-haiku-4-5-20251001 — TODA la IA usa Haiku)
