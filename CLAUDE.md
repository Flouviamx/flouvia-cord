...
| Integraciones (HubSpot, Slack, Zapier, Make) o Cord Workflows | [`docs/estado/integraciones.md`](docs/estado/integraciones.md) + catálogo en `src/lib/integraciones/catalogo.ts` y acciones en `src/lib/workflows/catalog.ts` |
