...
| Apps de Cord publicadas en otras plataformas (Zapier, Make, Slack, n8n) | `integrations/<plataforma>/README.md` + [`docs/estado/integraciones.md`](docs/estado/integraciones.md) + [`docs/estado/pendientes-make-zapier.md`](docs/estado/pendientes-make-zapier.md); los secretos de cada una viven en su `.env` ignorado |
