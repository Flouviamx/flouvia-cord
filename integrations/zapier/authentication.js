    ...
    fields: [
        {
            ...
            type: 'password',
            required: true,
            helpText: 'Create a secret key in Cord under **Settings › API**. Use a key with write permission: Zapier needs it to receive instant events and to create or update records. Keys that start with `sk_test_` work with your test environment.',
        },
    ],
    test,
