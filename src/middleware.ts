...
const PUBLIC_API_EXACT = ["/api/mcp", "/api/health", "/api/docs-search.json", "/api/geo", "/api/legal/oauth-intent", "/api/resend/marketing-webhook", "/api/integraciones/hubspot/webhook", "/api/integraciones/shopify/webhook", "/api/build/payment-intent", "/api/oauth/token", "/api/oauth/revoke", ...OPS_PUBLIC_API_EXACT];
