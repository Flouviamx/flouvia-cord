...
export const INTEGRATION_APPS: IntegrationApp[] = [
    ...
    { slug: 'zapier', nombre: 'Zapier', dominio: 'zapier.com', categoria: 'automatizacion', disponible: false, logo: favicon('zapier.com', 128), tile: true, guia: null },
];

export type IntegrationState = 'on' | 'warn' | 'off' | 'info' | 'soon';
