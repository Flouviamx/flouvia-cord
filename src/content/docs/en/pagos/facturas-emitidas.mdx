...
Commercial documents are included in Free (5/month); integrated fiscal issuance starts at Starter where enabled. The commercial option in Mexico and Spain is a pro forma, not a test invoice. It has no fiscal XML and does not replace a tax invoice.
