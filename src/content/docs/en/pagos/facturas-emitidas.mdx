...
To automate recurring invoices, open **View recurring**. To configure your country's fiscal rail — CFDI 4.0 in Mexico, Verifactu in Spain, or a commercial invoice everywhere else —, see [Fiscal invoicing by country](/en/docs/pagos/facturacion).
