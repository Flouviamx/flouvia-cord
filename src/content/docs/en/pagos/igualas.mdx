...
<Callout type="info">
Every monthly charge pays the same fee as a normal card payment — there's no volume discount for recurring charges. That fee (4% + $3.00 MXN + VAT) is the current rate for retainers charged in Mexican pesos; for a retainer in another currency, check **Settings › Payments**. See the details in [Fees and advantages](/en/docs/pagos/condiciones).
</Callout>
