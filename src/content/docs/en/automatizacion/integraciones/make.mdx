---
title: "Make"
description: "How to connect Cord with Make: receive Cord events in a scenario with Webhooks, create and update Cord data with the HTTP module, avoid duplicates and fix errors."
