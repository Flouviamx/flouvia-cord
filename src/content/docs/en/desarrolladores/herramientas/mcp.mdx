...
2. Generate an API Key if you don't have one — from the **API** tab of the
   [Cord Workbench](/en/docs/desarrolladores/herramientas/workbench). You need `write` scope to use
   `crear_cotizacion_borrador`; `read` is enough for the rest.
