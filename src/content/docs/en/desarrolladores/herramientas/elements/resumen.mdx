...
- **[React and Next.js Guide](/en/docs/desarrolladores/herramientas/elements/react)**
- **[Web Components and Vue Guide](/en/docs/desarrolladores/herramientas/elements/web-components)**
- **[Server SDK and Webhooks Guide](/en/docs/desarrolladores/herramientas/elements/server)**
...
<div data-cord-token="a1b2c3d4e5f60718"></div>
```
...
Explore the **[CSP Security](/en/docs/desarrolladores/herramientas/elements/seguridad)** section to configure your allowed domains (allowlist) and prevent Clickjacking attacks.
