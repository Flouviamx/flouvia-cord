...
<Callout type="info">
Your team can configure 16 endpoints on Free, Starter, and Professional, 32 on Scale, and 100 on
Developer. Subscriptions created by integrations through the API have a separate allowance of 100
per organization on every plan. Webhooks are NOT gated behind a paid plan.
</Callout>
