...
<Callout type="info">
**Atención:**
**Nunca expongas tus Claves Secretas.** Si tu clave secreta es comprometida, debes revocarla inmediatamente desde la pestaña **API** del dock de Desarrolladores.
</Callout>
