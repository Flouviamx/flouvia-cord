...
Toda petición programática a la API de Cord requiere una **Clave de API**. Puedes administrarlas, revocarlas y monitorear su uso desde la pestaña **API** del dock de Desarrolladores (actívalo en Ajustes > Empresa con el toggle "Modo desarrollador").
