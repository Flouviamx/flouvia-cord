...
inmutable y PDF. España tiene, además, su propio mecanismo de registro certificado
(Verifactu); el resto de los países usa el documento comercial como respaldo del cobro.
</Callout>
