...
- Al activar la opción "Cobro recurrente mensual", la cotización se convierte en una suscripción real de Cord Pagos (ver [Igualas recurrentes](/docs/pagos/igualas)).
