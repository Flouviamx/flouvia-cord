...
<Callout type="info">
**Una tarea es de tu cuenta, no de una cotización en particular.** Desde la interfaz se crea como seguimiento general de tu operación. Las tareas que crea un [workflow](/docs/automatizacion/workflows) o la API sí pueden quedar ligadas a la cotización que las originó.
</Callout>
