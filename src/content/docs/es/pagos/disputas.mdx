...
Cuando esto pasa con un cobro procesado por Cord Payments, verás el caso en el widget **Disputas abiertas** del [dashboard de cobros](/docs/pagos/dashboard), y podrás entrar a su página de detalle en **Mis cobros › Disputas**.
