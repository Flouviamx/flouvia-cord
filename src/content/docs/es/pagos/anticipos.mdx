...
<Callout type="info">
Cada cobro (el anticipo y el saldo) es una transacción independiente para efectos de comisión — Cord Payments cobra su tarifa sobre cada uno por separado, con la misma tabla de tarifas que un cobro normal. Ver [Tarifas y ventajas](/docs/pagos/condiciones).
</Callout>
