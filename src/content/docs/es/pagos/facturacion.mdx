...
1. En cuanto se confirma el cobro (por Tarjeta o SPEI dinámico a través de Cord Payments), el sistema notifica al servidor de Cord.
...
## El CFDI de la comisión de Cord Payments

Además del CFDI que timbras tú a tus propios clientes, Cord emite su **propio CFDI de ingreso** por la comisión que cobra en cada transacción de Cord Payments (ver [Tarifas y ventajas](/docs/pagos/condiciones)) — es el comprobante fiscal del servicio de procesamiento de pagos que Cord te presta, no el de tu venta.
