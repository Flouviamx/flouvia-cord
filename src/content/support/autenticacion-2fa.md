...
Protege tu cuenta de Cord y los datos de tu empresa añadiendo una capa de seguridad extra.

Gestionar el acceso y la configuración de tu empresa es el primer paso para una operación segura. Aquí te explicamos cómo administrar **Configurar autenticación en dos pasos (2FA)**.
