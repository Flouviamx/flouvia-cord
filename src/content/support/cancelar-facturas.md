...
Proceso para cancelar un CFDI timbrado y las diferencias con la emisión de Notas de Crédito.

El cumplimiento fiscal en México (SAT) requiere precisión absoluta. Cord automatiza la gran mayoría del proceso de **Cancelar facturas y notas de crédito**, pero es vital que configures tus catálogos corporativos correctamente.
