...
### Registrar el pago y generar el REP
...
Cord puede registrar el cobro en línea automáticamente, pero **no timbra el REP sin tu confirmación**. Revisa la fecha, monto, moneda, tipo de cambio y cuenta receptora antes de emitirlo. El tratamiento fiscal correcto sigue siendo responsabilidad del emisor.
