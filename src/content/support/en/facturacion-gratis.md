...
In Mexico and Spain, the commercial option is a clearly labeled **pro forma**.
It has a PDF and a public link, but it does not replace a tax invoice and does
...
uncertain, Cord keeps the reservation for review instead of issuing again.
Upgrading does not convert an existing pro forma into a CFDI; an existing fiscal
document is not converted into a commercial one on downgrade.

This change is implemented locally and awaits publication. See [plans and usage](/en/support/planes-suscripcion).
