...
**Settings › Invoicing › Issued invoices** brings together every CFDI you've stamped in a single table: folio, client, amount, date, and status. Each row has its own **PDF** and **XML** links ready to download.
