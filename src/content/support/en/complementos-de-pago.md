...
### Record the payment and generate the REP
...
Cord can record an online payment automatically, but it **does not stamp the REP without your confirmation**. Review the date, amount, currency, exchange rate, and receiving account before issuing it. Correct tax treatment remains the issuer's responsibility.
