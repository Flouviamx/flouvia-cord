  ...
  for (const q of overdue) {
    ...
    if (q.cliente_email) {
      await sendEmail({
        ...
        html: `<div style="background-color:#FAFAFA;padding:48px 20px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';">
        <div style="max-width:540px;margin:0 auto;background-color:#ffffff;border:1px solid #E5E7EB;border-radius:12px;overflow:hidden;">
            <div style="padding:48px;">
                <div style="font-size:16px;line-height:1.6;color:#111827;white-space:pre-wrap;font-weight:400;">${escapeHtml(msg)}</div>
            </div>
